...
rotatingPhoto.addEventListener("mouseover", function () {
    rotatingPhoto.style.transform = "rotate(360deg)";
});

rotatingPhoto.addEventListener("mouseout", function () {
    rotatingPhoto.style.transform = "rotate(0deg)";
});
